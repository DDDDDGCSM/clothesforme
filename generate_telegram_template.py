#!/usr/bin/env python3
"""
生成Telegram版本的UI模板 - 将所有WhatsApp替换为Telegram
"""
import json
    ...
    <style>
        * {{
        ...
        :root {{
            ...
            --telegram-color: {telegram_color};
            --telegram-dark: {telegram_color_dark};
            --telegram-light: {telegram_color_light};
        }}
        ...
        .telegram-icon {{
            ...
            cursor: pointer;
            transition: all 0.3s;
            background: linear-gradient(135deg, {telegram_color} 0%, {telegram_color_dark} 100%);
            border-radius: 50%;
            padding: 14px;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="modal" id="exchangeModal">
        <div class="modal-content">
            ...
            <div class="success-message" id="successMessage" style="display: none; margin-top: 28px; padding: 28px; background: linear-gradient(135deg, rgba(0, 136, 204, 0.15) 0%, rgba(0, 136, 204, 0.08) 100%); border-radius: 20px; color: {telegram_color}; text-align: center; font-size: 17px; font-weight: 900; border: 2px solid rgba(0, 136, 204, 0.3); text-transform: uppercase; letter-spacing: 1px;">
    ...
    <script>
        ...
        const translations = {{
            ...
            'telegram_number': '{translations['telegram_number']}'
        }};
        ...
        function trackEvent(eventType, payload) {{
            try {{
                ...
                // 为所有事件统一附带语言与路径信息
                extra.lang = PAGE_LANG;
                extra.path = window.location ? window.location.pathname : '';
        ...
        function displayAllItems() {{
            ...
            items.forEach((item, index) => {{
                ...
                const avatarElement = createAvatarElement(item.user);
                    ...
                    <div class="clothes-header">
                        ...
                        <div class="clothes-info">
                            ...
                            <div class="user-info">
                                ...
                                <div class="telegram-icon" onclick="openTelegram(${{item.id}}, ${{index}})" title="Contact via Telegram">
